...
public class ServerSocketThread extends Thread {
	...
	public void run() {
		while (true) {
			try {
				...
				// ZnzmDao znzmDao =
				// (ZnzmDao)springContextHelper.getBean("znzmDao");
				...
				if (sc.acceptRegister(strRec)) {
					...
					if (!"0".equals(success)) {
						...
						// 增加初始化查询znzm点
						List<Map<String, Object>> list = znzmDao
								.getallschedule();
						for (Map<String, Object> map : list) {
							String pointid = (String) map.get("pointid");
							sc.loopStatusRequ(pointid);
						}
	...
	/*
	 * public static void main(String [] args){ new ServerSocketThread();
	 * //可以成功启动线程 }
	 */
