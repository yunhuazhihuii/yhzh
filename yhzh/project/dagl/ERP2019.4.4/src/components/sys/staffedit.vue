           ...
           <div class="content-top">
               <el-form :model="form" class="roleform">
                ...
                <el-form-item label="员工密码:" :label-width="formLabelWidth">
                  <el-input type="password" v-model="form.password" autocomplete="off" size="small" style="width:30%"></el-input>
                </el-form-item>
...
<script>
    ...
    export default{
        ...
        methods:{
          ...
          getstaff(){
            this.staff = this.$route.params.staffcontent
            console.log(this.staff)

              this.form.userid = this.staff[0].userenname
              this.form.password = this.staff[0].password
              this.form.username = this.staff[0].usercnname
              this.userid_change = this.staff[0].userid

              this.radio = this.staff[0].roleid
              this.roleid = this.staff[0].roleid
              this.value = this.staff[0].compid
              this.compid = this.staff[0].compid
