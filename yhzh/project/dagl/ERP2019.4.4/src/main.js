...
import Login from './components/login.vue'
	...
	import role from './components/sys/role.vue'
		...
		import RoleEdit from './components/sys/roleedit.vue'
	import staff from './components/sys/staff.vue'
		import StaffAdd from './components/sys/staffadd.vue'
		import StaffEdit from './components/sys/staffedit.vue'
	...
	import Kpi from './components/sys/kpi.vue'
...
const routes = [
	...
	{ 
		...
		children:[
			...
			{ path: 'Staffedit',name:'Staffedit', component: StaffEdit },
