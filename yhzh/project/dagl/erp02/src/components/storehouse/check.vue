        ...
        <template v-for="(order,index) in orderShipnoRef">
            ...
            <div>
              ...
              <div class="right">
                ...
                <span>选项名称:{{order.variation_name}}</span><br/>
                <span>选项sku:{{order.variation_sku}}</span><br/>
               ...
               <!-- 产品详细 -->
                <template v-for="(item,itemindex) in order.items">
                  <div class="productdiv">
                    <div>
                      <span class="productlabel">产品{{itemindex+1}}：   {{qry_shippingno}}    </span>
                      <!-- 产品图片循环 -->
                      <template v-for="(img,imgindex) in item.images">
                        ...
                        <a class="tooltip" @click=tourl(rowindex,index) href="javascript:;">
                          ...
                          <img :src="img.src" width="50" height="50">
                            ...
                            <div class="inner">
                                <img :src="img.src" height="360" width="360" alt="">
                            </div>
