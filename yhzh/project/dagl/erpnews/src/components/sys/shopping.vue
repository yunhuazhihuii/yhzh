              ...
              <el-row class="elrow">
                  ...
                  <el-dialog
                    ...
                    <el-form :model="form1">
                      ...
                      <el-form-item label="用户名:" :label-width="formLabelWidth">
                        <el-input v-model="form1.username" autocomplete="off" size="small" style="width:60%"></el-input>
                      </el-form-item>
                      <el-form-item label="国家:" :label-width="formLabelWidth">
                        <el-input v-model="form1.country" autocomplete="off" size="small" style="width:60%"></el-input>
                      </el-form-item>
                      <el-form-item label="产品数量:" :label-width="formLabelWidth">
                        <el-input v-model="form1.pronum" autocomplete="off" size="small" style="width:60%"></el-input>
                      </el-form-item>
                      <el-form-item label="最大产品数量:" :label-width="formLabelWidth">
                        <el-input v-model="form1.maxpronum" autocomplete="off" size="small" style="width:60%"></el-input>
                      </el-form-item>
                  ...
                  <el-dialog
                    ...
                    <el-form :model="form">
                      ...
                      <el-form-item label="用户名:" :label-width="formLabelWidth">
                        <el-input v-model="form.username" autocomplete="off" size="small" style="width:60%"></el-input>
                      </el-form-item>
                      <el-form-item label="国家:" :label-width="formLabelWidth">
                        <el-input v-model="form.country" autocomplete="off" size="small" style="width:60%"></el-input>
                      </el-form-item>
                      <el-form-item label="产品数量:" :label-width="formLabelWidth">
                        <el-input v-model="form.pronum" autocomplete="off" size="small" style="width:60%"></el-input>
                      </el-form-item>
                      <el-form-item label="最大产品数量:" :label-width="formLabelWidth">
                        <el-input v-model="form.maxpronum" autocomplete="off" size="small" style="width:60%"></el-input>
                      </el-form-item>
                      <!-- <el-form-item label="店铺状态:" :label-width="formLabelWidth">
                        <el-radio v-model="radio" label="1">正常</el-radio>
                        <el-radio v-model="radio" label="2">封店</el-radio>
