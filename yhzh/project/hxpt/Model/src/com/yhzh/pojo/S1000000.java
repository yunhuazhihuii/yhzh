package com.yhzh.pojo;

import java.io.Serializable;
import java.util.Date;

public class S1000000 implements Serializable{
	...
	public String toString() {
		return "S1000000 [F1=" + F1 + ", F2=" + F2 + ", F3=" + F3 + ", F4=" + F4 + ", F5=" + F5 + ", F6=" + F6 + ", F7="
				+ F7 + ", F8=" + F8 + ", F9=" + F9 + ", F10=" + F10 + ", F11=" + F11 + "]";
	}
